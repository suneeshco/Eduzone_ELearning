...
const Footer: React.FC  = () => {
  return (
    ...
    <div className="px-4 py-6 bg-slate-700 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-white  sm:text-center">© 2024 <a href="https://flowbite.com/">Eduzone</a>. All Rights Reserved.
        </span>
