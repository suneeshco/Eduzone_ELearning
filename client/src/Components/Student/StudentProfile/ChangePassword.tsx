    ...
    <div className="bg-white mt-10 w-full pt-20 flex flex-col gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-[#161931]">
      <aside className="py-4 md:w-1/3 lg:w-1/4 hidden md:block">
        <div className="sticky flex flex-col gap-2 p-4 text-sm border-r border-indigo-100 top-12">
          ...
          <Link to={'/student/profile'}><a href="#" className="flex items-center px-3 py-2.5 font-semibold hover:text-indigo-900 hover:border hover:rounded-full">
            Public Profile
          </a></Link>
          ...
          <Link to={'/changePassword'}><a href="#" className="flex items-center px-3 py-2.5 font-bold bg-white text-indigo-900 border rounded-full">
            Change Password
          </a></Link>
