...
class InstructorErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
            ...
            return (
                <div className="flex flex-col items-center justify-center h-screen">
                    <div className="p-8 pr-20 rounded-lg text-center">
                        ...
                        <Link to="/instructor" className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-3 rounded focus:outline-none focus:shadow-outline">
                            Back to Home
                        </Link>
                    </div>
                </div>
