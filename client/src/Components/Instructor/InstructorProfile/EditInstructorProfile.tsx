            ...
            <form onSubmit={handleSubmit}>
              <div className="bg-slate-50 rounded-lg shadow-md p-4">
                ...
                <div className="mb-4">
                  ...
                  <input
                    type="email"
                    className={`appearance-none block w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${errors.email && touched.email ? 'border-red-500' : ''}`}
                    name="email"
                    value={values.email}
                    onChange={handleChange}
                    onBlur={handleBlur}
