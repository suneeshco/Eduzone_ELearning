...
export const InstructorSidebar: React.FC = () => {
  ...
  return (
    ...
    {/* {isOpen ? ( */}
      <div className="h-screen pl-8 pt-28 p-3 space-y-2 w-full bg-gray-300 " >
      ...
      <div className="divide-y ">
        <ul className="pt-2 pb-4 my-2 space-y-2 text-sm">
          <Link to={'/instructor'}><li className={` my-2 `}>
            <a rel="noopener noreferrer" className={`flex w-[95%] items-center px-3 py-2.5  ${location.pathname === '/instructor' ? 'bg-gray-700  border-black font-bold text-white'  : ' hover:bg-gray-400'} `}>
          ...
          <Link to={'/instructor/myCourses'}><li className=" my-2">
            <a rel="noopener noreferrer" href="#" className={`flex w-[95%] items-center px-3 py-2.5  ${location.pathname === '/instructor/myCourses' ? 'bg-gray-700  border-black font-bold text-white' : ' hover:bg-gray-400'}  `}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
          ...
          <Link to={'/instructor/chat'}><li className=" my-2">
            <a rel="noopener noreferrer" href="#" className={`flex w-[95%] items-center px-3 py-2.5  ${location.pathname === '/instructor/chat' ? 'bg-gray-700  border-black font-bold text-white' : ' hover:bg-gray-400'}   `}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
          ...
          <Link to={'/instructor/purchaseHistory'}>< li className=" my-2">
            <a rel="noopener noreferrer" href="#" className={`flex w-[95%] items-center px-3 py-2.5  ${location.pathname === '/instructor/purchaseHistory' ? 'bg-gray-700  border-black font-bold text-white' : ' hover:bg-gray-400'}  `}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
              ...
              <span className='pl-3'>Purchase History</span>
            </a>
          </li></Link>
          <Link to={'/instructor/addCourse'}><li>
            <a rel="noopener noreferrer" href="#" className={`flex w-[95%] items-center px-3 py-2.5  ${location.pathname === '/instructor/addCourse' ? 'bg-gray-700  border-black font-bold text-white' : ' hover:bg-gray-400'}   `}>
              ...
              <span className='pl-3 '>New Course</span>
            </a>
          </li></Link>
    ...
    {/* ) :(
      ...
      <button className='mt-20' onClick={()=>{setIsOpen(true)}}>Press</button>
