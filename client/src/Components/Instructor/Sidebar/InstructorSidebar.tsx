...
export const InstructorSidebar: React.FC = () => {
  ...
  return (
    //   <Card className="h-auto md:h-screen md:max-h-[calc(100vh-2rem)] md:w-[16rem] p-4 shadow-xl shadow-blue-gray-900/5 fixed top-20 left-0 w-full" style={{ maxHeight: 'calc(100vh - 20px)' }} placeholder={undefined}>
    ...
    //     </ListItem>
    //     </Link>
    //     <Link to={'/instructor/purchaseHistory'}>
    //     <ListItem placeholder={undefined} className='text-black'>
    //       <ListItemPrefix placeholder={undefined}>
    //         <UserCircleIcon className="h-5 w-5" />
    //       </ListItemPrefix>
    ...
    <>
      ...
      <div className="h-full pt-28 p-3 space-y-2 w-60    dark:text-gray-800 ">
        ...
        <div className="divide-y dark:divide-gray-300">
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            <Link to={'/instructor'}><li className="dark:bg-gray-100 dark:text-gray-900">
            ...
            <Link to={'/instructor/myCourses'}><li>
            ...
            <Link to={'/instructor/purchaseHistory'}><li>
              <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
